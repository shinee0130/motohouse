...
export function MotoCard({ m, showCc = false }: { m: Moto; showCc?: boolean }) {
  ...
  const priceEl = m.salePrice ? (
    <span style={{ display: "inline-flex", alignItems: "baseline", gap: 6, flexWrap: "wrap" }}>
      ...
      <span className="mh-card-price" style={sx("font:700 17px Montserrat;color:#E10613;")}><Price amount={m.salePrice} /></span>
    </span>
  ) : (
    <span className="mh-card-price" style={sx("font:700 17px Montserrat;color:#E10613;")}><Price amount={m.price} /></span>
  );
  return (
    <Link
    ...
    >
      <div className="mh-card-img" style={{ position: "relative", height: 190, background: "#0d0d0f" }}>
      ...
      <div className="mh-card-pad" style={{ padding: "18px 20px" }}>
        <div className="mh-card-title" style={sx("font:700 19px Montserrat;color:#fff;")}>
          {m.brand} {m.model}
        </div>
